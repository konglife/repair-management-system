          ...
          {selectedProduct && !isOpen ? (
            <div className="flex items-center justify-between p-2 border rounded-md bg-background">
              <div className="flex-1">
                ...
                <span className="text-sm text-muted-foreground ml-2">
                  {formatCurrency(selectedProduct.averageCost)} (Stock: {selectedProduct.quantity})
                </span>
              </div>
            ...
            <div className="relative">
              <SearchInput
                ...
                debounceMs={300} // 300ms debouncing for parts search
              />
              <Button
                type="button"
                variant="ghost"
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-muted-foreground">
                        {formatCurrency(product.averageCost)} • Stock: {product.quantity}
                      </div>
                    </div>
                    {value === product.id && (
